    ...
    <form class="needs-validation was-validated" id="createEmployee">
        <fieldset class="form-fieldset">
            <div class="mb-3">
                ...
                <input type="text" v-model="name" name="name" value="{{ $employee->name }}" class="form-control" autocomplete="off"/>
            </div>
            <div class="mb-3">
                <label class="form-label required">Employee Number</label>
                <input type="number"  v-model="number"  name="number" value="{{ $employee->employeenumber }}" class="form-control"  autocomplete="off"/>
            </div>
            <div class="mb-3">
                <label class="form-label required">Employee Date</label>
                <input type="date" v-model="date" name="date" value="{{ $employee->employeedate }}" class="form-control"  autocomplete="off"/>
            </div>
            <div class="mb-3">
...
@include('vue')
    ...
    <script>
            ...
            mounted(){
                    ...
                    this.number = '{{ $employee->employeenumber }}';
                    this.date = '{{ $employee->employeedate }}';
                },
            methods: {
                ...
                saveData: function(e) {
                    ...
                    axios.post('{{ route('employee.update') }}', formData).then(response => {
